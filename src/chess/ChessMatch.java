...
public class ChessMatch {
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition){
        ...
        ChessPiece moviedPiece = (ChessPiece)board.piece(target);

        //#specialmove promotion
        promoted = null;
        if(moviedPiece instanceof  Pawn){
            if(moviedPiece.getColor() == Color.WHITE && target.getRow() == 0 || (moviedPiece.getColor() == Color.BLACK &&  target.getRow() == 7)){
        ...
        if(moviedPiece instanceof Pawn && (target.getRow() == source.getRow() -2 || target.getRow() == source.getRow() + 2)){
            enPassantVulnerable = moviedPiece;
        }else{
